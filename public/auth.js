...
async function login() {
    ...
    // Optional, since they should't be able to: Basic check to ensure they didn't leave it blank
    if (!username) {
    ...
    try {
        // 2. Send the credentials to the Python server
        ...
        if (response.status === 200) {
            // SUCCESS! Extract the token from the server's reply
            ...
            // Hide the login overlay so the user can see the app!
            hideLoginOverlay();
